    ...
    <>
      ...
      <article>
        <div className={styles.postContainer}>
          ...
          <p>
            I take it you came to this article searching for the best cordless jigsaw that’s available on the market in 2021. While I can answer that
            question for you, the answer that is going to ensure you end up with the right tool is that it depends.
          </p>
          <p>
            In this article I’ll help you examine all of the cordless jigsaws that are available on the market today from the major manufacturers to
            figure out which best fits your needs.
          </p>
          <p>
            Before we look at the individual products there are a couple of things that you need to understand about the battery operated jigsaw
            landscape.
          </p>
          <h3>Traditional vs. Barrel Grip Jigsaws</h3>
          <p>
            The invisible hand of the market has done its work and determined that two styles of jigsaws must exist: Traditional handle, or D-Shaped
            grip jigsaws, and jigsaws that go without a handle commonly called barrel grip jigsaws.
          </p>
          <p>
            The important thing for you to understand about these two types is that there is essentially zero difference between how these two styles
            operate. The choice between the two comes down to your personal preference.
          </p>
          <p>
            The manufacturers will try to sell you on the argument that barrel grip jig saws are better geared towards detail work and traditional
            grip jig saws are better suited towards quick rough cuts, but this doesn’t really hold a lot of water if you listen to what folks who
            actually use both model says - which is that there is no real difference.
          </p>
          <p>
            One thing you may want to consider is that if you have large hands, a barrel grip jigsaw may be more comfortable to operate and vice versa
            if you have small hands. But honestly don’t stress about this choice too much.
          </p>
          <h3>Brushless Motors</h3>
          <p>
            You’ve probably heard about the fuss with brushless motors, but you may not understand what exactly the benefits are. Because brushless
            motors don’t have copper brushes rubbing against contacts, they use magnets instead, they don’t lose any power due to friction. This means
            a brushless tool will be more powerful and energy efficient than an equivalent traditional motor.
          </p>
          <p>
          ...
          <p>
            In just about every case a cordless jigsaw will be sold without a battery. You can of course by battery included kits, but they are more
            expensive - as you would expect. As we run down the list of jigsaws on the market I will be primarily evaluating the saws only, i.e.
            without batteries.
          </p>
          <p>
            This can become an important consideration if you have already bought into a tool family's cordless tool suite. It is much more convenient
            to manage a single set of batteries than multiple batteries from a range of manufacturers. In fact, if you do have a pre-existing
            collection of batteries from one manufacturer, It would be very difficult for me to recommend purchasing a tool from another family. The
            benefits you get from having compatible batteries for all your tools typically out-weigh other tool specific benefits or weaknesses.
          </p>
          <h3>Target Market</h3>
          <p>
            As you will see once we start looking at individual tools, manufacturers typically target their lineups to particular markets: home
            DIY’ers, professional contractors, or somewhere in the middle (let’s call them pro-sumer’s).
          </p>
          <p>
            I’ll give you an idea of where each tool falls in this article, but the big differentiators are the robustness of the tool and to a large
            extent, whether the tool has a brushless motor.
          </p>
          <p>
            The brushless motor is becoming a feature that is expected in professional tools due to the efficiency and power gains, but is too
            expensive to put in tools targeted for every day consumers.
          </p>
          <h3>Let’s Look at some Cordless Jig saws</h3>
          <p>I’m going to begin with my top pick that I think represents the all around best value for a cordless jig saw.</p>
          <h3>Top-Pick: Ridgid R8832B OCTANE 18V</h3>
          <p>
            The Ridgid R8832B is a pro-sumer model that usually sells for around $125 without a battery. This jig saw actually won the top spot in my
            book, because if you don’t already have a battery you can choose a battery included package for just about $30 extra, which is very
            inexpensive, and probably represents an attempt by Ridgid to pull people into their product lineup.
          </p>
          <ProductImage
          ...
          />
          <p>
            While I would classify this tool as a pro-sumer model, it does feature a lot of pro-level features: it has a brushless motor, variable
            speed trigger, a 1-inch cutting stroke and it operates up-to 3500 rpm - which is among the fastest of all the jigsaws on the market.
          </p>
          <p>It is a traditional grip jig saw and it is also very highly reviewed - ~4.7 rating through ~100 reviews on Amazon.</p>
          <BuyButton productLink="https://amzn.to/2La8GWf" />
          <p>
            With the top pick out of the way, let’s looks look at some of the other tools in the market according to where they fall in the
          ...
          <p>
            Just as with the pro models, it’s easy to recommend any of these, but stay within your current brand if you already have a collection of
            batteries.
          </p>
