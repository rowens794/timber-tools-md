...
excerpt: "Bosch's RA1171 is a great all around router table to have around your shop. I've been pleased with the performance and feature set of the Bosch RA1171."
...
![](https://res.cloudinary.com/dfebwzrhb/image/upload/v1609522288/TimberTools/Bosch-RA1171-Fence.jpg "Bosch RA1171 Fence")
...
If you are looking for a router table with a larger work surface, the [Kreg PRS1045](https://amzn.to/2piETKc) is a wonderful option that frequently jumps to the top of the conversation.  The trade-off is that the Kreg table costs ~2.5x what the Bosch RA1171 does.  For my limited budget, I'd rather save some $'s on the Bosch and buy myself another tool.

![](https://res.cloudinary.com/dfebwzrhb/image/upload/v1609522288/TimberTools/Bosch-Router-Table.jpg "Bosch Router Table")
