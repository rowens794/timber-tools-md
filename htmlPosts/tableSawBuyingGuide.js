  ...
  return (
    <div>
      <div class="markdown-styles_markdown__1x9gM">
        <p>
          In this, my first post of 2021, I’m going to provide you with the low down on setting yourself up with the right table saw. We are going to
          cover the different types of table-saws and who benefits from each type so that you can figure out which is right for your shop.
        </p>
        <p>
          ...
          feedback I’ve gotten from readers in the past, I know a lot you are looking for the best table saw under $500 and I can promise you I’ll
          help you find it.
        </p>
        <p>
          ...
          _allow me to spend the time to write this type of content. In total, I’ve invested about 20 hours in researching, writing, proofreading, and
          linking appropriately for this article alone. If you find the article helpful, please click on one of the red links - even if you don’t
          intend on buying anything, it’s an easy way to thank me and it costs you nothing.
        </p>
        <p>Let’s dive in!</p>
        <h2>The Types of Table Saws</h2>
        <p>
          <em>
            <a href="https://www.thesharpcut.com/table-saw-types/">https://www.thesharpcut.com/table-saw-types/</a>
          </em>
        </p>
        <p>
        ...
        <p>
          While the thought of portability may sound nice, you will actually need to think hard about how important portability is to you when you’re
        ...
        <p>
          ...
          on top of your workbench. They are also built to be moved. A typical benchtop saw weighs between 30-50 pounds. While you wouldn’t want to be
          lugging them around all of the time. They are easy enough to stow away in your garage.
        </p>
        <p>
        ...
        <p>
          To keep the weight of these saws down manufactures tend to use a lot of plastic in the body construction and while that can make these saws
          feel a bit flimsy, it typically has little effect on the operation.
        </p>
        <p>
          These saws tend to be aimed at light-duty users and as such, benchtop saws are usually among the least feature-rich saws on the market. You
          won’t get a stand or a fancy rip fence. But the feature light models do have a side benefit - benchtop saws tend to be among the least
        ...
        <p>
          ...
          are intended to travel to job sites, as the name suggests, so while they are heavy they are usually built with some degree of portability in
          mind.
        </p>
        <p>
        ...
        <p>
          Distinguishing between contractor saws and jobsite saws can be difficult nowadays and most of the difference comes down to marketing lingo.
          But generally when you hear people talking about contractor saws and comparing them to jobsite saws: contractor saws will be the larger more
        ...
        <p>
          ...
          everything that makes a cabinet saw the tool of choice for professional woodworkers, you do get a lot of great features in a hybrid saw. For
          instance, the tables on a hybrid saw are usually cast iron and much larger, usually 2x, than what you would get on a jobsite or contractor’s
          saw.
        </p>
        <p>
        ...
        <p>
          Hybrid saws represent a big step up in budget relative to contractor and jobsite saws. These units typically start at ~$1,000 and go all the
          way up to ~$3,000.
        </p>
        <h3>Cabinet saws</h3>
        <p>
          Cabinet saws are the go-to choice for professionals. They offer all of the features that make operation efficient, accurate, and easy. They
          have a large work surface that is made from high-quality materials, they feature high horsepower motors that can easily cut through thick
          dense material, and their components are accurate and easily adjusted.
        </p>
        <p>While all of this is great, it does come with some trade-offs that don’t work for a lot of hobbyist woodworkers.</p>
        <p>
          First, portability is non-existent, these saws almost always weigh over 500 pounds, so even scooting them to somewhere else inside your shop
          is out of the question without multiple helpers or equipment.
        </p>
        <p>
          Second, they require a lot of space. Most hobbyists are working out of their garage or basement. Installing equipment that takes up as much
          room as a small car is often out of the question.
        </p>
        <p>
        ...
        <p>
          At a budget of less than $300 you are going to be constrained primarily to benchtop saws. This isn’t necessarily a bad thing as you can get
          some quality tools at this price range. My two favorite saws for a budget of less than $300 are the <strong>Dewalt DWE7485</strong> and{" "}
          <strong>Delta 36-6013</strong>.
        </p>
        <h4>Dewalt DWE7485</h4>
        <p>
          This Dewalt Benchtop saw is great. It features a 24.5-inch rip capacity, which is important because that enables you to rip full-size sheet
          goods (4’x8’) to any width. It’s a very highly reviewed saw with a 4.8 rating across 3,600 reviews on Amazon. The biggest downside to this
          saw is the fact that it only has a 8.5-inch blade capacity, which means you won’t be able to rip 4-inch thick wood.
        </p>
        <p>
          <img
        ...
        <p>
          ...
          the Dewalt has significantly more ratings. The big advantage this saw has over the Dewalt is that it supports a 10-inch blade, which allows
          you to rip up-to 3 ⅛ inch stock.
        </p>
        <p>
        ...
        <p>
          ...
          10-inch blade for increased maximum depth cuts and it’s fence expands out to 35 inches, which is nice since the table can fully support that
          weight of sheet goods.
        </p>
        <p>
          <img
        ...
        <p>
          The biggest downside is that it is hard to find at &#x3C;$500. The standard amazon price is $600, but you will see it from time to time fall
          below the $500 mark, you just have to watch it consistently over time.
        </p>
        <p>
        ...
        <p>
          The Delta 5000 Series is another big upgrade in terms of the overall operation. This is a beef saw weighing in at ~300 lbs. It has a large
          and solid work surface that makes supporting material easy and a great fence system to cut material to width accurately. My father has this
          saw in a dedicated workshop, and even though I like my Bosch 4100, I always get a little bit jealous when I use his Delta.
        </p>
        <p>
        ...
        <p>
          ...
          and if you decide later on that the hobby isn’t for you, you should be able to get pretty close to your original purchase price selling the
          saw on craigslist or Facebook.
        </p>
      </div>
    </div>
  );
